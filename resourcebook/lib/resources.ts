...
export const SEED_RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    code: 'OBJ-ANCHOR',
    name: '앵커',
    lede: '제자리에 고정되며, 상태에 따라 컨트롤을 받거나 전량 전달하는 스페셜 오브젝트.',
    meta: [{ label: 'Key', code: 'object.anchor' }, { label: 'Type', code: 'special' }, { label: 'Move', code: 'fixed' }],
    hasControlStrip: true,
    stories: [
      { id: 'empty', title: '빈 앵커', desc: '컨트롤을 보유하지 않은 상태.', ref: 'OBJ-ANCHOR / Empty', state: 'OBJ-ANCHOR / Empty', controls: [] },
      { id: 'single', title: '컨트롤 1개', desc: '하나의 컨트롤을 보유.', ref: 'OBJ-ANCHOR / 1 Control', state: 'OBJ-ANCHOR / 1 Control', controls: ['→'] },
      { id: 'multiple', title: '컨트롤 복수', desc: '여러 컨트롤을 보유.', ref: 'OBJ-ANCHOR / Multiple Controls', state: 'OBJ-ANCHOR / Multiple Controls', controls: ['↑', '→'] },
      { id: 'receive', title: '컨트롤 수신', desc: '빈 앵커가 사용한 컨트롤을 받음.', ref: 'OBJ-NORMAL → OBJ-ANCHOR', state: 'OBJ-ANCHOR / Receive', controls: ['↑'] },
      { id: 'give', title: '전량 전달', desc: '기존 컨트롤 집합 전체를 전달하고 비움.', ref: 'OBJ-ANCHOR → OBJ-NORMAL', state: 'OBJ-ANCHOR / Give', controls: [] },
    ],
    sections: [
      {
        type: 'table',
      ...
      OWNERSHIP,
      {
        type: 'table',
        title: '동작',
        headers: ['상태', '충돌 조건', '동작', '결과'],
        rows: [
          ['빈 앵커', '오브젝트와 충돌', '컨트롤 수신', '사용한 컨트롤의 소유자가 앵커로 변경'],
          [
            '컨트롤 보유',
            '오브젝트와 충돌',
            '컨트롤 집합 전달',
            '앵커의 기존 컨트롤 집합 전체를 오브젝트에게 전달하고 앵커의 컨트롤 집합을 비움',
          ],
        ],
      },
      {
      ...
      },
      {
        type: 'relation',
        title: '관계',
        left: { strong: '앵커', code: 'OBJ-ANCHOR' },
        right: { strong: '일반 오브젝트 · 컨트롤 전달', code: 'anchor → OBJ-NORMAL' },
      },
      {
        type: 'table',
        title: '사운드',
        ...
        rows: [
          ...
          ['컨트롤 전달', '', '기존 컨트롤 집합 전체를 오브젝트에게 전달'],
        ],
      },
      {
        type: 'table',
    ...
    sources: [
      { book: 'CORE RULEBOOK', ref: 'p.6 · Object Reference · Anchor' },
      { book: 'CORE RULEBOOK', ref: 'p.8 · Special Object Rules · ANCHOR' },
    ],
  },
  {
    slug: 'obj-swapper',
